    ...
    <div class="settings__popup">
        ...
        <details>
            ...
            <div class="settings__param">
                ...
                <p>Настоятельно рекомендуем иногда<br/> сохранять настройки Q кнопкой<br/> "Импортировать"</p>
            </div>
            </details>
         <details>
            <summary class="settings__title">
            ...
            <div class="settings__param">
                <div class="settings__gpt">
                    <div class="settings__gptp"><input type="radio" id="qgpt" v-model="qgpt" :value="0"><label for="qgpt">Не использовать нейросети</label></div>
                    <div class="settings__gptp"><input type="radio" id="qgpt" v-model="qgpt" :value="1"><label for="qgpt">Включить QGPT</label></div>
                    <div class="settings__gptp"><input type="radio" id="qgpt" v-model="qgpt" :value="2"><label for="qgpt">Включить ChatGPT</label></div>
                </div>
                <div v-if="qgpt == 2">
                    <p>Ключ OpenAI</p>
